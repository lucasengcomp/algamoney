...
public class LancamentoRepositoryImpl implements LancamentoRepositotyQuery {
    ...
    public Page<Lancamento> filtrar(LancamentoFilter lancamentoFilter, Pageable pageable) {
        TypedQuery<Lancamento> query = criaQueryDoLancamento(lancamentoFilter);
        adicionarRestricoesDePaginacao(query, pageable);

        return new PageImpl<>(query.getResultList(), pageable, total(lancamentoFilter));
    }

    private TypedQuery<Lancamento> criaQueryDoLancamento(LancamentoFilter lancamentoFilter) {
